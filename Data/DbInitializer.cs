...
namespace ContosoUniversity.Data
{
    public class DbInitializer
    {
        public static void Initialize(SchoolContext context)
        {
            ...
            {
            new Course{CourseID=1050,Title="Chemistry",Credits=3, Instructor="Elowen Richardson", RoomNum="BHS 441"},
            new Course{CourseID=4022,Title="Microeconomics",Credits=3, Instructor="Corban Lam", RoomNum="JOY 900"},
            new Course{CourseID=4041,Title="Macroeconomics",Credits=3, Instructor="Mariella Potter", RoomNum="CP 821"},
            new Course{CourseID=1045,Title="Calculus",Credits=4, Instructor="Ross Calvert", RoomNum="BHS 397"},
            new Course{CourseID=3141,Title="Trigonometry",Credits=4, Instructor="Tahmid Carroll", RoomNum="JOY 675"},
            new Course{CourseID=2021,Title="Composition",Credits=3, Instructor="Tyler Moss", RoomNum="WG 564"},
            new Course{CourseID=2042,Title="Literature",Credits=4, Instructor="Bradleigh Mcghee", RoomNum="EDG 410"}
            };
